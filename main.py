...
def run_generation(genomes, config):
	...
	nets.append(net)
	genomes.fitness = 0 # every genome is not successful at the start
	...
	road = pygame.image.load('sprites/road3.png')
...
if __name__ == "__main__":
	...
	## run NEAT
	#
	#winner = p.run(run_generation, 10)
	#
	#print('\nBest genome\n{!s}'.format(winner))
